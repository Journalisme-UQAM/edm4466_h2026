...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/BxN1F1nhGZEAcZR0HuGO/intro/objectifs
---
...
Les plateformes numériques (on pense à Meta \[Facebook, Instagram, etc.], à Alphabet \[Google, YouTube, etc.], à Netflix, à Spotify, à AirBnb, à TikTok, à BeReal, à Uber, à OpenAI et à une foule d'autres) sont des systèmes. Ces systèmes sont composés, grosso modo, de deux éléments:
...
Dans ce cours, donc, vous allez créer des algorithmes et vous allez extraire du sens de grands ensembles de données. L'objectif de ces apprentissages n'est pas de vous transformer en robots; ni en spécialistes du développement logiciel. Accessoirement, oui, ce cours pourra vous permettre de mieux interagir avec des informaticiennes ou avec des analystes de données, car de plus en plus sont employées dans les médias.
